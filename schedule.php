...
<div class="container-fluid">
    <p class="stage text-center"> CULINARY STAGE </p>

    <div class="col-md-4"> <p class="stage text-center"> FRIDAY </p>
        <p class="time"> 12:00 p.m. </p>
        <p class="name"> Taking the Time for Tea </p>
        <p class="author"> Yvonne Robertson </p>
        <p class="author"> SAHARA TEA </p>
        <br/>

        <p class="time"> 1:15 p.m. </p>
        <p class="name"> Smoothies - How To Make 'Em </p>
        <p class="author"> Vicenza Mussico </p>
        <p class="author"> ROYAL DATES </p>
        <br/>

        <p class="time"> 2:00 p.m. </p>
        <p class="name"> 3 Meals in 30 Minutes </p>
        <p class="author"> Anne Elsbury and Mary Marino </p>
        <p class="author">  LA DEE DA GOURMET SAUCES</p>
        <br/>

        <p class="time"> 3:30 p.m. </p>
        <p class="name"> SPONSORED BY Nature's Path </p>
        <br/>

        <p class="time"> 4:15 p.m. </p>
        <p class="name"> Gluten Freedom: The Easy Way To Healthy Eating without Sacrificing Taste </p>
        <p class="author"> Executive Chef Jeffrey Willfong </p>
        <p class="author"> STE. ANNE'S SPA DESTINATION </p>
        <br/>

        <p class="time"> 5:00 p.m. </p>
        <p class="name"> The Great Gorp Project </p>
        <p class="author"> Colleen Dyck </p>
        <p class="author"> GORP ENERGY BARS </p>
        <br/>
        ...
        <p class="name"> Make your own Fermented Foods </p>
    ...
    <div class="col-md-4 day"> <p class="stage text-center"> SATURDAY </p> 
        ...
        <p class="name"> Healthy Can
            Taste SO Good! </p>
        <p class="author">Brenda Ross and
            Madeliene Garet </p>
        <p class="author"> LOW CARB CANADA </p>
        <br/>

        <p class="time"> 11:15 a.m. </p>
        <p class="name"> HMeet Miscela With Chef D!
            Introducing Your New
            Favourite Secret Ingredient </p>
        <p class="author">Chef Darryl Fletcher </p>
        <p class="author"> DERLEA BRAND FOODS </p>
        <br/>

        <p class="time"> 12:00 p.m. </p>
        <p class="name"> Live Baci Chocolate Theatre </p>
        <p class="author">Chef Christian Pritchard </p>
        <p class="author"> AURORA IMPORTS </p>
        <br/>

        <p class="time"> 12:45 p.m. </p>
        <p class="name"> Lunch/Dinner Prep - How To
            Use Leftover Chicken! </p>
        <p class="author">Kelly Atyeo-Fick </p>
        <p class="author"> CANADIAN CHICKEN
            FARMERS OF CANADA </p>
        <br/>
        ...
        <p class="name"> Ayurveda and Ways To
            Find Your Balance </p>
        <p class="author">Debra Joy Eklove,
            Ayurvedic Practitione </p>
        <p class="author"> TETLEY CANADA </p>
        <br/>

        <p class="time"> 3:45 p.m. </p>
        <p class="name"> Topic TBD </p>
    ...
    <div class="col-md-4 day"> <p class="stage text-center"> SUNDAY </p> 
        <p class="time"> 10:30 a.m. </p>
        <p class="name"> Allergy Free Cooking </p>
...
<div class="container-fluid">
    ...
    <div class="col-md-4 day"> <p class="stage text-center"> SATURDAY </p> 
        ...
        <p class="time"> 11:15 a.m. </p>
        <p class="name"> Nature's Own </p>
        <p class="author">Jordane Cosmetic </p>
        <br/>
        ...
        <p class="time"> 3:00 p.m. </p>
        <p class="name"> Comfort with Style </p>
        <p class="author">Esther Isman, </p>
        <p class="author"> ESH by Estee </p>
        <br/>
